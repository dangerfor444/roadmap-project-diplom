...
export interface ApiIdeaIdea extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'User-submitted product ideas';
    displayName: 'Idea';
    pluralName: 'ideas';
    singularName: 'idea';
  };
  ...
  attributes: {
    ...
    status: Schema.Attribute.Enumeration<
      ['new', 'under_review', 'planned', 'declined', 'done']
    > &
      Schema.Attribute.Required &
...
export interface ApiRoadmapItemRoadmapItem extends Struct.CollectionTypeSchema {
  ...
  info: {
    ...
    pluralName: 'roadmap-items';
    singularName: 'roadmap-item';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    status: Schema.Attribute.Enumeration<['planned', 'in_progress', 'done']> &
      Schema.Attribute.Required &
...
export interface ApiVoteVote extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A single vote for an idea by fingerprint';
    displayName: 'Vote';
    pluralName: 'votes';
    singularName: 'vote';
  };
